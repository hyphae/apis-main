...
public class DDCon {
	...
	public static AlarmState alarmState(String value) {
		try {
			...
			log.error("Failed to parse alarm state: " + value, e);
			return null;
		}
	}
	...
	public static AlarmState alarmStateFromCode(String value) {
		if (ALARM_STATE_CODE_NO_ALARM.equals(value))
			return AlarmState.NO_ALARM;
		if (ALARM_STATE_CODE_LIGHT_ALARM.equals(value))
			return AlarmState.LIGHT_ALARM;
		if (ALARM_STATE_CODE_HEAVY_ALARM.equals(value))
			return AlarmState.HEAVY_ALARM;
		return null;
	}
	...
	public static String codeFromAlarmState(AlarmState value) {
		switch (value) {
			case NO_ALARM:
				return ALARM_STATE_CODE_NO_ALARM;
			case LIGHT_ALARM:
				return ALARM_STATE_CODE_LIGHT_ALARM;
			case HEAVY_ALARM:
				return ALARM_STATE_CODE_HEAVY_ALARM;
			default:
				return null;
		}
	}
	...
	/**
	 * A string representing the voltage reference mode specification of the DCDC
	 * converter.
	 * Value: {@value}
	 * 
	...
	/**
	 * Fetch the constant corresponding to a DCDC converter mode specification
	 * constant string.
	 * 
	...
	public static Mode mode(String value) {
		try {
			...
			log.error("Failed to parse mode: " + value, e);
			return null;
		}
	}
	...
	public static Mode modeFromCode(String value) {
		if (MODE_CODE_WAIT.equals(value))
			return Mode.WAIT;
		if (MODE_CODE_VOLTAGE_REFERENCE.equals(value))
			return Mode.VOLTAGE_REFERENCE;
		if (MODE_CODE_CHARGE.equals(value))
			return Mode.CHARGE;
		if (MODE_CODE_DISCHARGE.equals(value))
	...
	public static String codeFromMode(Mode value) {
		switch (value) {
			case WAIT:
				return MODE_CODE_WAIT;
			case VOLTAGE_REFERENCE:
				return MODE_CODE_VOLTAGE_REFERENCE;
			case CHARGE:
				return MODE_CODE_CHARGE;
			case DISCHARGE:
				return MODE_CODE_DISCHARGE;
			default:
				return null;
		}
	}
	...
	/**
	 * A string representing the voltage reference operating mode of the DCDC
	 * converter.
	 * Value: {@value}
	 * 
	...
	/**
	 * Fetch the constant corresponding to a DCDC converter operating mode constant
	 * string.
	 * 
	...
	public static OperationMode operationMode(String value) {
		try {
			...
			log.error("Failed to parse operation mode: " + value, e);
			return null;
		}
	}
	...
	public static OperationMode operationModeFromCode(String value) {
		if (OPERATION_MODE_CODE_WAITING.equals(value))
			return OperationMode.WAITING;
		if (OPERATION_MODE_CODE_GRID_AUTONOMY.equals(value))
			return OperationMode.GRID_AUTONOMY;
		if (OPERATION_MODE_CODE_HETERONOMY_CV.equals(value))
			return OperationMode.HETERONOMY_CV;
		return null;
	}
	...
	public static String codeFromOperationMode(OperationMode value) {
		switch (value) {
			case WAITING:
				return OPERATION_MODE_CODE_WAITING;
			case GRID_AUTONOMY:
				return OPERATION_MODE_CODE_GRID_AUTONOMY;
			case HETERONOMY_CV:
				return OPERATION_MODE_CODE_HETERONOMY_CV;
			default:
				return null;
		}
	}
