 ...
 * Also shut down the apis-tools participating in the cluster (apis-web and
 * apis-ccc).
 * 
 * @author OES Project
 * 
...
public class ShutdownAll extends AbstractErrorAction {
	 ...
	 * @param policy      a POLICY object. To prevent changes from taking effect
	 *                    while running, a copy is passed at
	 *                    {@link jp.co.sony.csl.dcoes.apis.main.app.user.ErrorHandling}
	 *                    or
	 *                    {@link jp.co.sony.csl.dcoes.apis.main.app.gridmaster.main_loop.ErrorHandling}.
	 * @param logMessages a list of log messages recorded in error handling
	 * 
	 *                    インスタンスを生成する.
	 * @param vertx       vertx オブジェクト
	 * @param policy      POLICY オブジェクト. 処理中に変更されても影響しないように
	 *                    {@link jp.co.sony.csl.dcoes.apis.main.app.user.ErrorHandling}
	 *                    あるいは
	 *                    {@link jp.co.sony.csl.dcoes.apis.main.app.gridmaster.main_loop.ErrorHandling}
	 *                    でコピーしたものが渡される.
	...
	protected void doAction(Handler<AsyncResult<Void>> completionHandler) {
		if (log.isInfoEnabled())
			log.info("publishing shutdown message to all units ...");
